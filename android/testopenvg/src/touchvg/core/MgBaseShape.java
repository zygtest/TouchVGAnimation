...
public class MgBaseShape extends MgObject {
  ...
  public void setOwner(MgShape owner) {
    touchvgJNI.MgBaseShape_setOwner(swigCPtr, this, MgShape.getCPtr(owner), owner);
  }
  ...
  public int getChangeCount() {
    return touchvgJNI.MgBaseShape_getChangeCount(swigCPtr, this);
  }

  public void resetChangeCount(int count) {
    touchvgJNI.MgBaseShape_resetChangeCount(swigCPtr, this, count);
  }

  public void afterChanged() {
    touchvgJNI.MgBaseShape_afterChanged(swigCPtr, this);
  }
  ...
  public void copy(MgObject src) {
    touchvgJNI.MgBaseShape_copy(swigCPtr, this, MgObject.getCPtr(src), src);
  }

  public boolean equals(MgObject src) {
    return touchvgJNI.MgBaseShape_equals(swigCPtr, this, MgObject.getCPtr(src), src);
  }

  public boolean isKindOf(int type) {
    return touchvgJNI.MgBaseShape_isKindOf(swigCPtr, this, type);
  }
